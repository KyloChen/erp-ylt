<template>
  <el-container>
    <el-header>
      <el-button v-show="serverShown" type="primary" icon="el-icon-circle-plus-outline" @click="addToken">新增权限</el-button>
    ...
    >
      <el-table-column label="权限编号" width="250" align="center">
        <template slot-scope="scope">
          {{ scope.row.id }}
        </template>
      </el-table-column>
      <el-table-column label="权限介绍" width="250" align="center">
        <template slot-scope="scope">
...
<script>
import qs from 'qs'
import { getList, deleteToken } from '@/api/token/token'
import { formatDate } from '../../../dataFormat'
import AddIndex from '@/views/token/AddIndex'
