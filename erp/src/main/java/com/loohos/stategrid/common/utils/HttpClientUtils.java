package com.loohos.stategrid.common.utils;
...
public class HttpClientUtils {
    ...
    public String doPostWithString(String url, Map<String, String> headMap, String msg){
        String responseContent = null;
        CloseableHttpClient httpClient = HttpClients.createDefault();
        try{
            HttpPost httpPost = new HttpPost(url);
    ...
    public static String sendToServer(JSONObject jsonObject, String url){
